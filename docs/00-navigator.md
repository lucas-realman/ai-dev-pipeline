...
│
├── 09-operations/                            # ⑨ 运行、运维与使用
│   ├── ✅ OPS-001-运维手册-Runbook.md        #    日常运维、故障排查、恢复
│   ├── ✅ OPS-002-部署手册-Deployment.md     #    本地部署、Docker 部署、验收清单
│   ├── ✅ OPS-003-风险识别与应对.md           #    7 项风险 + 应对策略
│   └── ✅ USER-001-用户手册.md              #    安装、配置、干跑、Sprint 执行
│
├── 10-references/                            # ⑩ 参考资料
...
除 `docs/` 外，v3.0.0 还补充以下交付物目录：

```text
release/
└── ✅ RELEASE_NOTES-v3.0.0.md                #    版本发布说明

reports/
└── ✅ TEST-REPORT-v3.0.0.md                  #    测试执行摘要与覆盖率结论
```
...
| 12 | [OPS-001](09-operations/OPS-001-运维手册-Runbook.md) | 运维手册 + 故障排查 | — |
| 13 | [OPS-002](09-operations/OPS-002-部署手册-Deployment.md) | 部署步骤 + 验收清单 | — |
| 14 | [OPS-003](09-operations/OPS-003-风险识别与应对.md) | 风险登记 + 应对策略 | RISK-001~007 |
| 15 | [USER-001](09-operations/USER-001-用户手册.md) | 使用步骤 + 常见问题 | — |
| 16 | [REF-001](10-references/REF-001-术语表.md) | 术语 + 缩略语 + 编号体系 | — |
| 17 | [评审纪要 v1.0](12-review/v1.0/评审总结.md) | 8 角色评审 + 36 行动项 + 综合评分 | A-001~036 |
| 18 | [评审纪要 v4.0](12-review/v4.0/ACTION-ITEMS.md) | 8角色+4技术专项, 31项发现, 3.4/5 | A-001~031 |
