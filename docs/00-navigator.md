...
| 8 | [TEST-001](06-testing/TEST-001-测试策略与方案.md) | 4 层测试 + 45 用例 + 自动化 | TC-001~123 |
| 9 | [TRACE-001](05-traceability/TRACE-001-追溯矩阵.md) | 全链路追溯 + 覆盖率 | 全部 ID 交叉引用 |
| 10 | [ITER-001](07-iteration/ITER-001-迭代计划.md) | 里程碑 + Sprint 节奏 | M0~M3 |
| 11 | [OPS-003](08-operations/OPS-003-风险识别与应对.md) | 风险登记 + 应对策略 | RISK-001~007 |
| 12 | [REF-001](09-references/REF-001-术语表.md) | 术语 + 缩略语 + 编号体系 | — |
| 13 | [评审纪要 v1.0](11-review/v1.0/评审总结.md) | 8 角色评审 + 36 行动项 + 综合评分 | A-001~036 |
...
7. [TEST-001](06-testing/TEST-001-测试策略与方案.md) — 质量保障体系

### 持续跟踪

8. [TRACE-001](05-traceability/TRACE-001-追溯矩阵.md) — 全链路追溯 & 覆盖率
9. [ITER-001](07-iteration/ITER-001-迭代计划.md) — 进度与里程碑
...
| `TRACE-` | 追溯矩阵 | 05-traceability/ | TRACE-001 |
| `TEST-` | 测试设计 | 06-testing/ | TEST-001 |
| `ITER-` | 迭代计划 | 07-iteration/ | ITER-001 |
| `OPS-` | 运维风险 | 08-operations/ | OPS-003 |
| `REF-` | 参考资料 | 09-references/ | REF-001 |
| `RV-` | 评审纪要 | 11-review/ | v1.0/ |
...
docs/05-traceability/   →  追踪「设计 = 实现?」     →  全 ID 交叉引用
docs/06-testing/        →  定义「怎么验证」         →  TC-001~123 → tests/*.py
docs/07-iteration/      →  规划「节奏与里程碑」
docs/08-operations/     →  管理「风险与运维」
docs/09-references/     →  统一「术语与编号」
```
...
- 自动生成的文档 (sprint report 等) 放在 `07-iteration/sprints/` 和 `reports/`
